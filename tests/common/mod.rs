...
/// Sentinel-2 NDVI scene: 1024x1024 chunked [256, 512] — a geometry where one
/// chunk spans many non-contiguous rows, which is what makes read amplification
/// visible. Generated by `uv run scripts/gen_ndvi_scene.py`.
pub const NDVI_SCENE: &str = "data/s2_ndvi_scene.zarr";
